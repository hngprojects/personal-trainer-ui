...
const SECTIONS: LegalSection[] = [
      ...
      <>
        ...
        <div className="space-y-4 pl-4">
          <p className="text-sm leading-relaxed">
            ...
            Name, email address, and profile photo (via Google and Apple
            Authentication).
          </p>
          <p className="text-sm leading-relaxed">
            <span className="font-bold text-muted-foreground block mb-0.5">
          ...
          <p className="text-sm leading-relaxed">
            ...
            We do not store your full credit card details. Payments are
            processed through secure third-party providers (Apple/Google Pay),
            which handle your financial data according to their own privacy
            policies.
          </p>
        </div>
      </>
      ...
      <>
        ...
        <div className="space-y-4 pl-4">
          <p className="text-sm leading-relaxed">
            ...
            We share the Client’s name and contact information only with the
            trainer they have booked, to facilitate the training session.
          </p>
          <p className="text-sm leading-relaxed">
            <span className="font-bold text-muted-foreground block mb-0.5">
              Service Providers
            </span>
            We may use third-party tools (e.g., messenger for video, hosting
            providers) that require limited access to data to function
            correctly.
          </p>
          <p className="text-sm leading-relaxed">
            <span className="font-bold text-muted-foreground block mb-0.5">
            ...
            If required by law or to protect the safety of our users, we may
            disclose data to relevant authorities.
          </p>
        </div>
      </>
    ),
  },
  {
    ...
    content: (
      <p className="text-sm leading-relaxed">
        We employ industry-standard security measures (encryption and secure
        server hosting via Netlify/GitHub) to protect your data. However, no
        internet-based service is 100% secure, and we encourage you to protect
