...
import { DiscoveryHistoryTable } from './DiscoveryHistoryTable'
...
export function DiscoverySlotsManager() {
  ...
  return (
    <div className='space-y-8'>
      ...
      <div className='border-b border-[#E5E7EB] bg-white px-4 rounded-[12px]'>
        <ReusableTabs
          tabs={tabs}
          activeTab={activeTab}
          onTabChange={(tab) => setActiveTab(tab as 'slots' | 'history')}
          layoutId='discovery-tabs'
